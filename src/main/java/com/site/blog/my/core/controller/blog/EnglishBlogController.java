...
@Controller
@RequestMapping("/en")
public class EnglishBlogController {
...
//    public static String theme = "amaze";
    ...
    public String link(HttpServletRequest request) {
        request.setAttribute("pageName", "Website");
    ...
    public String about(HttpServletRequest request) {
        ...
        if (blogDetailVO != null) {
            request.setAttribute("blogDetailVO", blogDetailVO);
            request.setAttribute("pageName", "About-Me");
            request.setAttribute("configurations", configService.getAllConfigs());
            return "blog/" + theme + "/detail";
        } else {
            return "error/error_400";
    ...
    public String aboutBlog(HttpServletRequest request) {
        ...
        if (blogDetailVO != null) {
            request.setAttribute("blogDetailVO", blogDetailVO);
            request.setAttribute("pageName", "About-Blog");
            request.setAttribute("configurations", configService.getAllConfigs());
            return "blog/" + theme + "/detail";
        } else {
            return "error/error_400";
    ...
    public String project(HttpServletRequest request) {
        request.setAttribute("pageName", "Project");
        Map<Byte, List<BlogLink>> linkMap = linkService.getLinksForLinkPage();
        if (linkMap != null) {
            //判断类别并封装数据 8-个人项目
